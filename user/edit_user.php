...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('Data pengguna berhasil diupdate!'); window.location='data_user.php';</script>";
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <label>Saldo</label>
                        <input type="number" name="saldo" step="0.01" class="form-control" value="<?= $data['saldo'] ?>">
