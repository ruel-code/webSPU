...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO user (nama_lengkap, email, no_hp, alamat, saldo)
              VALUES ('$nama', '$email', '$no_hp', '$alamat', '$saldo')";
    mysqli_query($koneksi, $query);

    echo "<script>alert('Data pengguna berhasil ditambahkan!'); window.location='data_user.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <input type="number" name="saldo" step="0.01" class="form-control" value="0.00">
