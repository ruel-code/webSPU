            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = mysqli_query($koneksi, "SELECT * FROM admin");while ($row = mysqli_fetch_assoc($sql)) {
                                echo "<tr>
                                        <td>{$row['id_admin']}</td>
                                        <td>{$row['username']}</td>
                                        ...
                                        <td>{$row['no_hp']}</td>
                                        <td>
                                            <a href='edit_admin.php?id={$row['id_admin']}' class='btn btn-sm btn-warning'>Edit</a>
                                            <a href='hapus_admin.php?id={$row['id_admin']}' class='btn btn-sm btn-danger' onclick=\"return confirm('Hapus data ini?')\">Hapus</a>
                                        </td>
                                      </tr>";
                            }
                            ?>
