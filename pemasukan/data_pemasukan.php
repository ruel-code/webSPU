                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_assoc($query)) {
                                ...
                                echo "<tr>
                                          ...
                                          <td>
                                              <a href='edit_pemasukan.php?id={$data['id_pemasukan']}' class='btn btn-warning btn-sm'>Edit</a>
                                              <a href='hapus_pemasukan.php?id={$data['id_pemasukan']}' class='btn btn-danger btn-sm'onclick=\"return confirm('Yakin ingin hapus?')\">Hapus</a>
                                          </td>
                                      </tr>";
                                $no++;
                            }
